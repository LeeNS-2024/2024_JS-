...
/* art + shift + r -> 함수 내 같은이름을 같이 바꿀 수 있음 */
...
function check13() {
  ...
  for (let num = 1; num <= 20; num++) { // 1 ~ 20까지 1씩 증가하는 반복문
...
/** 1부터 100사이의 정수 중 입력받은 값의 배수가 몇 개인지 구하기 */
function check21() {
