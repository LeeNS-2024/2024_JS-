...
/* const input1 = document.getElementById("input1");  'Id'가 들어가 있으니 가져오는 id에 # 안 붙여도 됨 */
...
document.querySelector("#btn3").addEventListener("click", function () {
  ...
  // inputs 요소별로 값을 얻어와 숫자로 변환해 숫자 배열에 저장
...
function pow(num, x) {
  ...
  let result = 1; // 곱셈에 영향을 주지 않는 1로 초기화
